...
# Production Fp64 — same semantics but allow FMA contraction for perf
# (results are numerically "equivalent" but not bitwise).
...
function(_tdmd_apply_mixed_fast_aggressive target)
  ...
  message(
    STATUS "  [flavor stub] MixedFastAggressiveBuild on target ${target} — M2 TODO")
endfunction()

function(_tdmd_apply_fp32_experimental target)
  _tdmd_define_flavor(${target} TDMD_FLAVOR_FP32_EXPERIMENTAL)
  message(
    STATUS "  [flavor stub] Fp32ExperimentalBuild on target ${target} — M2 TODO")
endfunction()
...
function(tdmd_apply_build_flavor target)
  ...
  # Every target also gets the warnings policy and the flavor name as a
  # compile definition (useful for runtime identification in telemetry).
  tdmd_apply_warnings(${target})
  target_compile_definitions(${target}
                             PUBLIC "TDMD_BUILD_FLAVOR_NAME=\"${TDMD_BUILD_FLAVOR}\"")
endfunction()
