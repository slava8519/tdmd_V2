...
**Module:** `gpu/`
**Status:** master module spec v1.0.20 (T8.9 shipped — SnapGpuMixed narrow-FP32 pair-math kernel active on MixedFastSnapOnlyBuild; D-M8-8 dense-cutoff gate measured at 9.51e-6 rel force / 1.70e-9 rel PE / 3.94e-9 rel virial on T6 tungsten 2000-atom BCC; ctest green across Fp64Reference+CUDA / MixedFast+CUDA / MixedFastSnapOnly+CUDA / CPU-strict)
